...
public class Controleur implements KeyListener {
	...
	switch (e.getKeyCode()) {
	// si on appuie sur KeyEvent.VK_LEFT,commande joueur est gauche
	case KeyEvent.VK_LEFT:
	    this.commandeEnCours.gauche = true;
	    this.commandeARetourner.gauche = true;
	    break;
	    // si on appuie sur KeyEvent.VK_RIGHT,commande joueur est droite
	case KeyEvent.VK_RIGHT:
	    this.commandeEnCours.droite = true;
	    this.commandeARetourner.droite = true;
	    break;
	    // si on appuie sur KeyEvent.VK_UP,commande joueur est haut
	case KeyEvent.VK_UP:
	    this.commandeEnCours.haut = true;
	    this.commandeARetourner.haut = true;
	    break;
	    // si on appuie sur KeyEvent.VK_DOWN,commande joueur est bas
