...
public class SpaceInvadersTest {
	...
	spaceinvaders.recupererMissilesVaisseau().add((MissileVaisseau) vaisseau.tirerUnMissile(new Dimension(3,2), 2));
	...
	spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Position(15, 9), new Envahisseur(new Dimension(2,2), new Position(4,3), 1), 3);
	fail("Position trop à droite : devrait déclencher une exception HorsEspaceJeuException");
    }
	...
	spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Position(-1, 9), new Envahisseur(new Dimension(2,2), new Position(4,3), 1), 3);
	fail("Position trop à gauche : devrait déclencher une exception HorsEspaceJeuException");
    }
	...
	spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Position(14, 10), new Envahisseur(new Dimension(2,2), new Position(4,3), 1), 3);
	fail("Position trop en bas : devrait déclencher une exception HorsEspaceJeuException");
    }
	...
	spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Position(14, -1), new Envahisseur(new Dimension(2,2), new Position(4,3), 1), 3);
	fail("Position trop à haut : devrait déclencher une exception HorsEspaceJeuException");
	...
	spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Position(5, 3), new Envahisseur(new Dimension(2,10), new Position(4,3), 1), 3);
	...
	spaceinvaders.positionnerUneNouvelleLigneEnvahisseurs(new Position(0, 3), new Envahisseur(new Dimension(2,2), new Position(4,3), 1), 6);
